...
Missing:
* TTY names of xterm and similar tools. Maybe this could be found by parsing /dev/pts/?
...
Drop it. If really needed, it can be replaced using wtmp entries in the journal.
